...
class APIWrappersViewController: ViewController {
    ...
    override func viewDidLoad() {
        ...
        // also test two way binding
        let sliderValue: BehaviorRelay<Float> = BehaviorRelay(value: 1.0)
        ...
        let attributedTextValue: BehaviorRelay<NSAttributedString?> = BehaviorRelay(value: NSAttributedString(string: ""))
        ...
        let attributedTextViewValue: BehaviorRelay<NSAttributedString?> = BehaviorRelay(value:NSAttributedString(string: ""))
